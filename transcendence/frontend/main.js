...
import { initializeWebGL } from "./pong/pong_webgl.js";
import { initializeGame } from "./pong/pong_game_logic.js";
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  document
    ...
    ?.addEventListener("click", () => applyTheme("high-contrast"));
  document
    .getElementById("toggleFontSizeBtn")
